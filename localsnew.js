...
I18N.zh = {
    ...
    "pubilc": { // 公共区域翻译
        "static": { // 静态翻译
            ...
            "Search or jump to...": "GitHub 一下，你就知道",
    ...
    "page-account": { // 个人设置
        "static": { // 静态翻译
            ...
            "Name": "昵称",
			"Your name may appear around GitHub where you contribute or are mentioned. You can remove it at any time.": "你的名字可能会出现在GitHub的周围，你的贡献或被提及的地方。您可以随时删除它。",
            "Public email": "公共邮箱",
			"Bio": "个人简介",
			...
			"Trending settings": "倾向设置",
			"Preferred spoken language": "首选语言",
			"We'll use this language preference to filter the trending repository lists on Explore and our Trending Repositories page.": "我们将使用此语言首选项来筛选发现页和倾向设置页面上的趋势存储库列表",
			"Save Trending settings": "保存倾向设置",
			
			"Emoji": "当前情绪",
			"Preferred default emoji skin tone": "当前情绪",
			"Update preference": "更新喜好",
    ...
    "issues": { // 问题页面
        "static": { // 静态翻译
            ...
            "You could search all of GitHub or try an": "您可以查找整个代码仓库或者尝试",
            "advanced search.": "高级搜索查询",
            "ProTip!": "专业提示！",
